...
-- NO USAR (ES PARA DEMOSTRAR EN LA PRESENTACION)
INSERT INTO `parque` (`cod_parque`,`cod_tipo`,`nombre`,`direccion`,`telefono`,`email`,`aforo`,`estado`,`horario`,`pagina_web`,`url_reserva`,`descripcion`,`img`,`mapa`,`ubicacion`) VALUES 
('7','1','Parque Metropolitano de Santiago', 'Pío Nono #450, Recoleta, Santiago', '+56 22730 1300', 'info@parquemet.cl', '400','1', 'Lun-Dom 7-19:30hrs','https://www.parquemet.cl/',null, 'Parque Metropolitano o Cerro San Cristóbal es el pulmón verde más grande de Santiago con más de 700 hectáreas de extensión, lo que sitúa como el cuarto parque urbano más grande del mundo. Aquí podrás encontrar cultura, recreación, educación ambiental y deporte, todo en contacto permanente con la naturaleza.','metImg.jpg','metMapa.jpg',ST_GeomFromText('POINT(-70.61723066116804 -33.41026434526121)'))